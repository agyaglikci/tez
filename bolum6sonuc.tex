...
\end{longtable}
Her bir adada 16 SIMD lane ve 32 warp bulunduğundan eş zamanlı olarak platform üzerinde çalışabilecek toplam thread sayısı 2048'dir. Bu seçenekte adalar yerleştirildikten sonra boş kalan \%31.52'lik kısım bellek ara yüzü, PCI-e arayüzü ve scheduler için değerlendirilir.\par
