...
\centering \includegraphics{gorsel/instructionTypes.eps} \caption{Tosun Buyruk Türleri}  
\end{figure}
...
\centering \includegraphics{gorsel/pipelineStages.eps} \caption{Tosun Boru Hattı Mimarisi}  
\end{figure}
...
\begin{figure}[h] \label{image:genelMimari} 
\centering \includegraphics{gorsel/genelMimari.png} \caption{Tosun Üst Seviye Mimarisi}  
\end{figure}
...
\begin{figure}[h] \label{image:adaMimarisiEski} 
...
\centering \includegraphics{gorsel/adaMimarisi.png} \caption{Tosun Ada Mimarisi (Boru Hattı)}  
\end{figure}
...
\begin{figure}[h] \label{image:registerFile} 
\centering \includegraphics{gorsel/registerFile.png} \caption{Tosun Yazmaç Öbeği}  
\end{figure}
...
\begin{figure}[h] \label{image:executionUnitIO} 
\centering \includegraphics{gorsel/executionUnitIO.png} \caption{Hesaplama Modülleri}  
\end{figure}
